...
export const projects: Project[] = [
  ...
  },
  {
    id: 'meridb',
    name: 'MeriDB',
    description: '[WIP] - SQL database built from scratch in Rust',
    longDescription:
  ...
  },
  {
    ...
    name: 'indexium',
    description:
      'Implementation of all the major indexing data structures commonly used in database internals.',
    longDescription:
  ...
  },
  {
    ...
    name: 'input_handler',
    description:
      'Maintains history in your rust cli apps, allows terminal-style editing.',
    longDescription:
  ...
  },
  {
    ...
    name: 'Cinequest',
    description:
      'This project is a combination of a React frontend and a Django backend. This is a movies website whe...',
    longDescription:
  ...
  },
  {
    ...
    description:
      "Expense Manager is a hybrid app to manage and store user's transactions , made with React Native and...",
    longDescription:
      "Expense Manager is a hybrid app to manage and store user's transactions , made with React Native and firebase ",
    category: ['Personal'],
  ...
  },
  {
    ...
    longDescription:
      'Full Stack Library Management system following MVC (Model-View-Controller) architecture, fully dockerised, hosted locally on apache',
    category: ['Personal'],
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    company: 'SDSLabs',
    description:
      'Maintaining and developing applications for campus and internet',
