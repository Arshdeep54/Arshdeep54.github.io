  ...
  return (
    <section className="py-20 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <h2 className="text-3xl font-light text-foreground mb-2">Experience</h2>
          <p className="text-muted-foreground">Professional roles and open-source contributions</p>
        </div>
